...
setup(
    name='omniscient',
    version='0.0.0',
    description='API for text analytics',
    long_description=long_description,
    long_description_content_type='text/markdown',
    url='https://github.com/tanviraumi/python-starter',
    author='Tanvir Aumi',
    classifiers=[
    ...
    # Optional
    extras_require={
        # consider making the cuda support optional. Especially once
        # pip-compile deals with
